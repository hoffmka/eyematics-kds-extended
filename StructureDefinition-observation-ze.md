# Ellipsoid zone disruption - Eyematics Core Data Set v2025.0.0-alpha

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Ellipsoid zone disruption**

## Resource Profile: Ellipsoid zone disruption 

| | |
| :--- | :--- |
| *Official URL*:https://eyematics.org/fhir/eyematics-kds-extended/StructureDefinition/OCT-EZ-Disruption | *Version*:2025.0.0-alpha |
| Draft as of 2025-10-18 | *Computable Name*:MII_EyeMatics_OCT_EZDisruption |

 
OCT finding describing the disruption of the ellipsoid zone (EZ) in the retina. 

**Usages:**

* This Profile is not used by any profiles in this Implementation Guide

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/eyematics-kerndatensatz|current/StructureDefinition/observation-ze)
...
Other representations of profile: [CSV](StructureDefinition-observation-ze.csv), [Excel](StructureDefinition-observation-ze.xlsx), [Schematron](StructureDefinition-observation-ze.sch) 
...
```json
{
  ...
  "name" : "MII_EyeMatics_OCT_EZDisruption",
