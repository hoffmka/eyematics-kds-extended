# Optic Disc Diameter - Eyematics Core Data Set v2025.0.0-alpha

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Optic Disc Diameter**

## Resource Profile: Optic Disc Diameter 

| | |
| :--- | :--- |
| *Official URL*:https://eyematics.org/fhir/eyematics-kds/StructureDefinition/OpticDiscDiameter | *Version*:2025.0.0-alpha |
| Draft as of 2025-10-17 | *Computable Name*:MII_EyeMatics_OpticDiscDiameter |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/eyematics-kerndatensatz|current/StructureDefinition/OpticDiscDiameter)
...
Other representations of profile: [CSV](StructureDefinition-OpticDiscDiameter.csv), [Excel](StructureDefinition-OpticDiscDiameter.xlsx), [Schematron](StructureDefinition-OpticDiscDiameter.sch) 
    ...
    "element" : [
      ...
      },
      {
        ...
        "patternCoding" : {
          ...
          "code" : "392158006",
          "display" : "Vertical diameter of optic disc (observable entity)"
        },
        "mustSupport" : true
      },
      {
      ...
      },
      {
        ...
        "short" : "The diameter of the optic disc measured in mm",
        "type" : [
          {
            "code" : "Quantity"
          }
